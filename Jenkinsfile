            ...
            steps {
                ...
                sh '''
                    docker run --name zap \
                        ...
                        -t ghcr.io/zaproxy/zaproxy:stable bash -c "zap.sh -cmd -addonupdate && zap.sh -cmd -addoninstall communityScripts -addoninstall pscanrulesAlpha -addoninstall pscanrulesBeta && zap.sh -cmd -autorun /zap/wrk/passive.yaml" || true
                ''' 
            }
        }
    }
